...
<html lang="de">
  <head>
    ...
    <title>Unsere Projekte - Alfredo Media</title>
    ...
    <section class="portfolio-section">
      <div class="container">
        ...
        <div class="project-grid">
          ...
          <div class="project-card">
            ...
            <div class="project-info">
              <h3 class="project-title">Webdesign & Branding</h3>
              <p class="project-desc">
                Eine moderne Website mit starkem Branding für einen lokalen
                Geschäftskunden.
              </p>
          ...
          <div class="project-card">
            ...
            />
            <div class="project-info">
              <h3 class="project-title">Digital Marketing Kampagne</h3>
              <p class="project-desc">
                Umfassende Social-Media-Strategie mit beeindruckenden
                Ergebnissen.
              </p>
              <a href="#" class="btn btn-primary">MEHR ERFAHREN</a>
            </div>
          ...
          <!-- Project 3 -->
          <div class="project-card">
            <img src="https://cdn.pixabay.com/photo/2017/12/12/12/44/bitcoin-3014614_960_720.jpg" alt="Projekt 3" class="project-image" />
            <div class="project-info">
              <h3 class="project-title">E-Commerce Website</h3>
              <p class="project-desc">
                Vollständige Online-Shop-Lösung mit integriertem Zahlungssystem.
              </p>
              <a href="#" class="btn btn-primary">MEHR ERFAHREN</a>
            </div>
          </div>
        ...
        <div class="cta-section">
          ...
          <a href="home.html#contact" class="btn btn-accent"
            >KONTAKT AUFNEHMEN</a
          >
        </div>
      </div>
