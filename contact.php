  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul class="footer-links">
          <li class="footer-link">
            <a href="mailto:louis.lampe@icloud.com"
              >Email: louis.lampe@icloud.com</a
            >
          </li>
          <li class="footer-link">
            <a href="tel:1735611892">Telefon: 1735611892</a>
          </li>
          <li class="footer-link">
            <a href="#">Adresse: Worthgarten 10, 32549 Bad Oeynhausen</a>
          </li>
        </ul>
      </div>
    </div>
